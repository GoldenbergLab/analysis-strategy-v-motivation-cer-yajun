...
summary_control <- data.frame(
  group_cond_new = c('Baseline', 'Reappraisal Only',
                'Group-Focused Motivation Only', 'Group-Focused Reappraisal'),
...
summary_control$group_cond_new <- factor(summary_control$group_cond_new, 
                                         levels = c('Baseline', 'Group-Focused Motivation Only', 'Reappraisal Only',
                 'Group-Focused Reappraisal'))


colors <- c("Baseline" = "black", "Reappraisal Only" = "blue", 
            "Group-Focused Motivation Only" = "red", "Group-Focused Reappraisal" = "purple")
...
plot_cont_sum <- ggplot(summary_control, aes(x = group_cond_new, y = mean_rate, color = group_cond_new)) +
  ...
  theme(legend.position = "none",  # Remove legend
        ...
        axis.title.x = element_text(size = rel(1.5)),  # Increase size of x-axis title
        axis.title.y = element_text(size = rel(1.5))) +  # Add axis lines
  labs(x = "Treatment Condition", y = "Non-Treated Subgroup Negative Emotions")  
